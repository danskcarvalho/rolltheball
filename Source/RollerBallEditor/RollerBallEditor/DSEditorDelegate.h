...
@property (weak) IBOutlet NSButtonCell *distribHorOption;
@property (weak) IBOutlet NSButtonCell *distribVerOption;
@property (weak) IBOutlet NSButtonCell *distribAlongPath;
@property (weak) IBOutlet NSTextField *distribSpaceTxt;
@property (weak) IBOutlet NSButton *distribClampOption;
@property (weak) IBOutlet NSTextField *distribMinTxt;
@property (weak) IBOutlet NSTextField *distribMaxTxt;
...
@property (strong) IBOutlet NSWindow *distributeWindow;
@property (strong) NSMutableArray* components;
@property (weak) IBOutlet NSTextField *pfActionTxt;
@property (weak) IBOutlet NSButtonCell *pfActionClassOpt;
@property (weak) IBOutlet NSPopUpButton *pfActionSel;
@property (strong) IBOutlet NSWindow *pfActionWindow;
